...
export default function MyNavbar() {
    ...
    return (
        <nav className={`bg-white pb-5 lg:text-sm ${state ? "shadow-lg rounded-xl border mx-2 mt-2 lg:shadow-none lg:border-none lg:mx-2 lg:mt-0" : ""}`}>
            <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 lg:flex lg:px-8">
                ...
                <div className={`flex-1 items-center mt-8 lg:mt-0 lg:flex ${state ? 'block' : 'hidden'} `}>
                    ...
                    <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 lg:flex lg:space-y-0 lg:mt-0">
                        ...
                        <a href="javascript:void(0)" className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900 rounded-full lg:inline-flex">
                            Sign in
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" />
                            </svg>
